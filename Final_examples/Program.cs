...
// Предложим задать колличество элементов массива и проверим введённые данные.
...
// Определим колличество строк длинна которых меньше или равна 3. 
int newLength = 0;
